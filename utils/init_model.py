...
from wenet.transformer.asr_model import ASRModel, ContrastiveASRModel
...
def init_model(configs):
    ...
    if 'predictor' in configs:
        ...
        model = Transducer(vocab_size=vocab_size,
                           ...
                           ctc=ctc,
                           **configs['model_conf'])
    elif 'ctc_contrastive' in configs:
        model = ContrastiveASRModel(vocab_size=vocab_size,
                                    encoder=encoder,
                                    ctc=ctc,
